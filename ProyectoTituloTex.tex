...
\paragraph{}
Luego de obtener las subseñales de 2.048 puntos, se les aplica la transformada rápida de Fourier (FFT) obteniéndose la misma cantidad de componentes de frecuencias. Dado que la transformada tiene la propiedad de simetría, es posible tomar los primeros 1.024 coeficientes de Fourier para cada muestra. A continuación se aplica valor absoluto a las componentes y se elevan al cuadrado para conseguir la energía del espectro de Fourier, dando lugar a las características.
...
\paragraph{}
Obtenidas las características, se reordenan de manera aleatoria las nuevas muestras contenidas en los conjuntos de datos y se divide cada uno estos en dos partes: un conjunto de entrenamiento con 413 (70\%) muestras y uno de testing con 177 (30\%) muestras. El conjunto de entrenamiento tiene como objetivo encontrar los mejores parámetros posibles de las capas ocultas de la DNN (pesos y biases). El de testing es usado para medir la exactitud (Ecc. \ref{acc}) del modelo propuesto en este trabajo.
...
\toprule
Nro & $\lambda_{1}$ & $\beta_{1}$ & $\rho_{1}$ & $\lambda_{2}$ & $\beta_{2}$ & $\rho_{2}$\\
\midrule
1 & 0,0033 & 95,5766 & 0,2125 & 0,0039 & 94,3802 & 0,0817\\
\addlinespace
2 & 0,0097 & 95,0160 & 0,1137 & 0,0137 & 95,2099 & 0,0945\\
\addlinespace
3 & 0,0029 & 94,3067 & 0,3486 & 0,0207 &	94,0471 & 0,3009\\
\addlinespace
4 & 0,0098 & 95,8236 & 0,2339 & 0,0041 & 98,9872 & 0,1407\\
\addlinespace
5 & 0,0071 & 91,5199 & 0,2265 & 0,0175 & 95,7748 & 0,3659\\
\addlinespace
6 & 0,0140 & 98,6471 & 0,2759 & 0,0113 & 94,0828 & 0,2092\\
\addlinespace
7 & 0,0185 & 94,4216 & 0,0609 & 0,0128 & 96,1257 & 0,2855\\
\addlinespace
8 & 0,0162 & 96,6491 & 0,1300 & 0,0046 & 97,8639 & 0,3855\\
\addlinespace
