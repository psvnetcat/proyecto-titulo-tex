...
\subsubsection{Naturaleza de la señal de vibración}
\paragraph{}
...
\bibitem {jia}Yang Yu, YuDejie y Cheng Junsheng, \textit{Deep neural networks: A promising tool for fault characteristic mining and intelligent diagnosis of rotating machinery with massive data}, Mechanical Systems and Signal Processing, 2015

\bibitem {yu}Feng Jia, YaguoLei, Jing Lin, Xin Zhou y Na Lu, \textit{A roller bearing fault diagnosis method based
